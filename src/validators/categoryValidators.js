...
const isNullableObjectIdOrNullString = (v) =>
  v === undefined || v === null || v === 'null' || /^[0-9a-fA-F]{24}$/.test(String(v));
...
const getCategoriesQuery = [
  ...
  query('parent')
    .optional()
    .custom(isNullableObjectIdOrNullString).withMessage('errors.validation.invalid_object_id'),
